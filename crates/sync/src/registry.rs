...
//! [`hearth_doc::RegistryDoc`] under a lock. Wire frames are JSON text —
...
use hearth_doc::{PendingBatch, RegistryDoc, RegistryRow, StateOutcome};
...
// ── stats (RoomStatsSnapshot-compatible so SyncStatus/`hearth sync` render it) ─
