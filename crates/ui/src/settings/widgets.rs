...
//! (hearth settings.devices.tsx / settings.agents.tsx / settings.archived.tsx).
...
/// title + `text-[13px]` count sharing a baseline (hearth settings.devices.tsx).
...
/// Display-only toggle switch (hearth branch-picker.tsx `Toggle`): an 18×32
