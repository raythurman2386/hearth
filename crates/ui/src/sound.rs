...
//! - `HEARTH_DISABLE_SOUND` env kill-switch + the `soundEnabled` ui-setting;
...
const DISABLE_ENV: &str = "HEARTH_DISABLE_SOUND";
...
fn temp_path() -> PathBuf {
    ...
    std::env::temp_dir().join(format!("hearth-sound-{}-{id}.wav", std::process::id()))
}
...
use hearth_proto::SessionStatus;
