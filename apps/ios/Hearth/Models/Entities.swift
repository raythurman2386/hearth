...
/// Provider-neutral lifecycle state from `hearth-proto`.
...
/// hearth-proto FolderListing (entities.rs:225): the device's answer to
...
/// hearth-proto RepoRef (entities.rs:193): one selectable ref from ListRefs.
...
/// hearth-proto WorktreeSpec (agent.rs, PR #159): a worktree the HOST
...
/// hearth-proto RunRequest (agent.rs:81). `reasoning` is lowercase
