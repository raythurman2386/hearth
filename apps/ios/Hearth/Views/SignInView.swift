...
enum Endpoints {
    ...
    static let callbackScheme = "hearth"
...
struct SignInView: View {
    ...
    /// The AuthKit code flow: system browser session → hearth://callback with
...
/// (crates/ui/assets/icons/hearth-logo.svg), cells scaled from its 820×940
